...
namespace Company.FamilyTree
{
	...
	/// </remarks>
	public partial class FamilyTreeToolboxHelper : FamilyTreeToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new FamilyTreeToolboxHelper.
		/// </summary>
		public FamilyTreeToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class FamilyTreeToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify FamilyTree toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "FamilyTree.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify ParentLink connector tool.
		/// </summary>
		public const string ParentLinkFilterString = "ParentLink.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify ResidenceConnection connector tool.
		/// </summary>
		public const string ResidenceConnectionFilterString = "ResidenceConnection.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify NationalityConnector connector tool.
		/// </summary>
		public const string NationalityConnectorFilterString = "NationalityConnector.1.0";
		...
		/// <summary>
		/// Constructs a new FamilyTreeToolboxHelperBase.
		/// </summary>
		protected FamilyTreeToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("FamilyTreeToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.FamilyTree.FamilyTreeDomainModel));
