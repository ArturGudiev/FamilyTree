...
namespace Company.FamilyTree
{
	...
	/// </remarks>
	public partial class FamilyTreeHelpKeywordHelper : FamilyTreeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FamilyTreeHelpKeywordHelper.
		/// </summary>
		protected FamilyTreeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FamilyTreeHelpKeywordHelper.
		/// </summary>
		public static FamilyTreeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FamilyTreeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FamilyTreeHelpKeywordHelperBase.
		/// </summary>
		protected FamilyTreeHelpKeywordHelperBase()
			: base() { }
