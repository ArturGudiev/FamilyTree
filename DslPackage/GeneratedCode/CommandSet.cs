...
namespace Company.FamilyTree
{
	...
	/// </summary>
	internal partial class FamilyTreeCommandSet : FamilyTreeCommandSetBase
	{
		/// <summary>
		/// Constructs a new FamilyTreeCommandSet.
		/// </summary>
		public FamilyTreeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class FamilyTreeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new FamilyTreeCommandSetBase.
		/// </summary>
		protected FamilyTreeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewFamilyTreeExplorerCommand,
				typeof(FamilyTreeEditorFactory).GUID);
		...
		{
			FamilyTreeExplorerToolWindow explorer = this.FamilyTreeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected FamilyTreeDocData CurrentFamilyTreeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as FamilyTreeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected FamilyTreeDocView CurrentFamilyTreeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as FamilyTreeDocView;
			}
		}
		...
		/// </summary>
		protected FamilyTreeExplorerToolWindow FamilyTreeExplorerToolWindow
		{
			get
			{
				FamilyTreeExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(FamilyTreeExplorerToolWindow), true) as FamilyTreeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				FamilyTreeExplorerToolWindow explorerWindow = this.FamilyTreeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class FamilyTreeClipboardCommandSet : FamilyTreeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new FamilyTreeClipboardCommandSet.
		/// </summary>
		public FamilyTreeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class FamilyTreeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new FamilyTreeClipboardCommandSetBase.
		/// </summary>
		protected FamilyTreeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
