...
namespace Company.FamilyTree
{
	...
	/// </summary>
	internal partial class FamilyTreeDocData : FamilyTreeDocDataBase
	{
		/// <summary>
		/// Constructs a new FamilyTreeDocData.
		/// </summary>
		public FamilyTreeDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a FamilyTree document in memory.
	/// </summary>
	internal abstract partial class FamilyTreeDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FamilyTreeDocDataBase.
		/// </summary>
		protected FamilyTreeDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Company.FamilyTree.FamilyTreeDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Company.FamilyTree.FamilyTreeDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Company.FamilyTree.FamilyTreeModel modelRoot = null;
			...
			global::Company.FamilyTree.FamilyTreeDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Company.FamilyTree.FamilyTreeSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Company.FamilyTree.FamilyTreeModel modelRoot = (global::Company.FamilyTree.FamilyTreeModel)this.RootElement;
			...
			{
				global::Company.FamilyTree.FamilyTreeDiagram diagram = diagrams[0] as global::Company.FamilyTree.FamilyTreeDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Company.FamilyTree.FamilyTreeSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Company.FamilyTree.FamilyTreeSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Company.FamilyTree.FamilyTreeDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Company.FamilyTree.FamilyTreeSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Company.FamilyTree.FamilyTreeModel modelRoot = this.RootElement as global::Company.FamilyTree.FamilyTreeModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Company.FamilyTree.FamilyTreeSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
