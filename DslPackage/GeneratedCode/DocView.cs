...
namespace Company.FamilyTree
{
	...
	/// </summary>
	internal partial class FamilyTreeDocView : FamilyTreeDocViewBase
	{
		/// <summary>
		/// Constructs a new FamilyTreeDocView.
		/// </summary>
		public FamilyTreeDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FamilyTreeDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FamilyTreeDocView.
		/// </summary>
		protected FamilyTreeDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			FamilyTreeDocDataBase docData = this.DocData as FamilyTreeDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for FamilyTreeDocViewBase should be an FamilyTreeDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.FamilyTree.FamilyTreeDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.FamilyTree.FamilyTreeDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.FamilyTree.FamilyTreeToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.FamilyTree.FamilyTreeToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FamilyTreeDiagramMenu;
			}
		}
			...
			if(global::Company.FamilyTree.FamilyTreeHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.FamilyTree.FamilyTreeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
